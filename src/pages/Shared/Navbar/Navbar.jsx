...
const Navbar = () => {
    ...
    const navItems = <>
        ...
        <div className="dropdown dropdown-hover py-0 pl-2 cursor-pointer brandFont ml-2 lg:ml-0 z-50">
            ...
            <ul tabIndex={0} className="dropdown-content menu p-2 shadow shadow-slate-300 bg-base-100 rounded w-60 top-10 -left-14 z-50 brandFont space-y-3">
                ...
                <li><NavLink to="/clearance" className={({ isActive }) => (isActive ? "navActive border-b rounded-none" : "navDefault border-b rounded-none")}>Clearance</NavLink></li>
...
<li>
    ...
    return (
        <section className='navBg sticky top-0 z-50'>
