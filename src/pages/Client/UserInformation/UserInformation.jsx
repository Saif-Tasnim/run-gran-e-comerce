...
const UserInformation = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000//quote?email=${user?.email}`)
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/team-order?email=${user?.email}`)
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/team-store?email=${user?.email}`)
            .then(res => res.json())
